...
-- AddForeignKey
ALTER TABLE "events" ADD CONSTRAINT "events_pembicara_id_fkey" FOREIGN KEY ("pembicara_id") REFERENCES "speakersnp"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
